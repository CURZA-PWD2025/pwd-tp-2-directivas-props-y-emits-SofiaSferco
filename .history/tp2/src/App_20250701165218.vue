...
import { ref } from 'vue';
import CardComponent from './components/CardComponent.vue';C:\Users\cotre\Desktop\Trabajos Practicos PWD\pwd-tp-2-directivas-props-y-emits-SofiaSferco\tp2\src\components\CardComponent.vue
